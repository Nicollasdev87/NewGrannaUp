...
const Navbar: React.FC<NavbarProps> = ({ setScreen, userAvatar, userName }) => {
  return (
    <header className="h-20 fixed top-0 left-0 right-0 bg-surface-light/95 dark:bg-surface-dark/95 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 z-50 shadow-sm transition-all duration-300">
      <div className="w-full h-full md:pl-20">
        <div className="h-full w-full max-w-6xl mx-auto px-4 md:px-8 flex items-center justify-between">
          <div className="flex items-center gap-6 w-full max-w-2xl">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-bold text-slate-900 dark:text-white tracking-tight">GranaUp</h1>
            </div>
            <div className="h-8 w-[1px] bg-slate-200 dark:bg-slate-700 mx-4 hidden md:block"></div>
